...
class Rossmann(object):
    ...
    def __init__(self):
        self.home_path = '/home/lucashilario/repos/DataScience_Em_Producao/'
    ...
    def feature_engineering(self, df2):
        ...
        df2 = df2[(df2['open'] != 0)] # open: loja fechada não têm vendas / sales: loja sem vendas

        ## 3.2 Seleção das Colunas
        cols_drop = ['open','promo_interval', 'month_map'] # customers: no momento da predição, não saberemos qual a quantidade de clientes
